...
tab2 = PGM[PGM$REGULATION == "Up-regulated",]
table(tab2$EXPRESSION_PROFIL)

tab2 = KU80c[KU80c$REGULATION == "Up-regulated",]
table(tab2$EXPRESSION_PROFIL)

tab2 = XRCC4[XRCC4$REGULATION == "Up-regulated",]
table(tab2$EXPRESSION_PROFIL)

tab2 = EZL1[EZL1$REGULATION == "Up-regulated",]
table(tab2$EXPRESSION_PROFIL)

tab2 = CTIP_e[CTIP_e$REGULATION == "Down-regulated",]
table(tab2$EXPRESSION_PROFIL)

tab2 = CTIP_i[CTIP_i$REGULATION == "Down-regulated",]
table(tab2$EXPRESSION_PROFIL)
