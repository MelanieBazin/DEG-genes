...
PCA_plot_generator(log(data_tab+1),
                   colors = color,
...
data_tab = OrderColumn(norma, infodata)
...
data_tab = OrderColumn(vsd, infodata)
...
data_tab = OrderColumn(rlg, infodata)
