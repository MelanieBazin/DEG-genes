...
for (correction in c("_SansCorrectionBatch/","/")){
  ...
  dir.create(paste0(path,c,"_ComBat/4Cluster/"),recursive=T,showWarnings=F)
  for (distance in c("Pearson", "Spearman")){
    png(paste0(path,c,"_ComBat/4Cluster/", condition,"_Matrice_",distance,".png"),  width = 600, height = 600)
    ...
    for (method in c("kmeans", "HCL")){
      ...
      png(paste0(path,c,"_ComBat/4Cluster/", condition,"_Cluster_",method,"_",distance,".png"),  width = 800, height = 600)
